...
| ------------------------------------------------------------------------------------ | --------------------------- | -------------------------- | ------------------------------- | ------------------------------------ | ----------------------------------------- | ------------------------ | ----------------------- |
| [LightEdge-NANO](https://github.com/ultralytics/ultralytics) (custom)                 | 640                         | —                           | —                               | —                                    | —                                         | 3.0                      | 13.5                    |
| [LightEdge-SMALL](https://github.com/ultralytics/ultralytics) (custom)                | 640                         | —                           | —                               | —                                    | —                                         | 8.4                      | 34.3                    |
...
> **LightEdge-YOLO** is a custom NMS-free object detection architecture included in this repo. It uses a RepViTGhost hybrid backbone, Adaptive BiFPN neck, and a decoupled one-to-one head for edge deployment. LightEdge-NANO (3.0M params, 13.5 GFLOPs) targets devices like Raspberry Pi and Jetson Nano, while LightEdge-SMALL (8.4M params, 34.3 GFLOPs) balances accuracy and speed for mobile and embedded inference. See [`ultralytics/nn/modules/lightedge.py`](ultralytics/nn/modules/lightedge.py) for details.

...
class DynamicTransformerBlock(nn.Module):
    ...
    """
    def __init__(self, c1, c2, n=2, num_heads=4):
        super().__init__()
        ...
        # Reduced hidden channels (c2//4 instead of c2//2) for lighter integration
        self.hidden_c = max(16, c2 // 4)

        # ---- Channel split via 1x1 conv (identical to C2PSA) ----
        self.cv1 = Conv(c1, 2 * self.hidden_c, 1, 1)

        # ---- Stack of DynamicPSABlocks (controlled by n via repeat_modules) ----

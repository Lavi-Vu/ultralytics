...
from ultralytics.utils.plotting import plot_images_mutilabel, plot_results_multi_label
...
class MultiLabelClassificationTrainer(BaseTrainer):
    ...
    def get_dataloader(self, dataset_path, batch_size=16, rank=0, mode="train"):
        ...
        loader = build_dataloader(dataset, batch_size, workers=self.args.workers, rank=rank)
    ...
    def plot_metrics(self):
        ...
        plot_results_multi_label(file=self.csv, classify=True, on_plot=self.on_plot)  # save results.png

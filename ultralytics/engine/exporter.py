...
from ultralytics.nn.modules import C2f, Classify, Detect, LightEdgeDecoder, RTDETRDecoder, Segment26, SemanticSegment
...
class Exporter:
    ...
    def __call__(self, model=None) -> str:
        ...
        for m in model.modules():
            ...
            if isinstance(m, (Detect, RTDETRDecoder, LightEdgeDecoder)):  # includes all Detect subclasses like Segment, Pose, OBB

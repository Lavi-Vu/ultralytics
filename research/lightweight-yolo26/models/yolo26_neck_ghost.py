"""YOLO26-N with GhostConv Neck (Track 2, H4).

Same channel topology as baseline — only C3k2 internals change.
"""
...
class YOLO26NeckGhost(nn.Module):
    """YOLO26-Nano with GhostConv in all neck C3k2 blocks."""
    ...
    def __init__(self, nc=80, reg_max=1, end2end=True):
        ...
        self.n_cat1 = _Concat()
        self.n11 = GhostC3k2(_w(1024) + _w(512), _w(512), _d(2), True)
        self.n_up2 = nn.Upsample(scale_factor=2, mode="nearest")
        self.n_cat2 = _Concat()
        self.n12 = GhostC3k2(_w(512) + _w(512), _w(256), _d(2), True)
        self.n_down1 = Conv(_w(256), _w(256), 3, 2)
        self.n_cat3 = _Concat()
        self.n13 = GhostC3k2(_w(256) + _w(512), _w(512), _d(2), True)
        self.n_down2 = Conv(_w(512), _w(512), 3, 2)
        self.n_cat4 = _Concat()
        self.n14 = GhostC3k2(_w(512) + _w(1024), _w(1024), _d(1), True)

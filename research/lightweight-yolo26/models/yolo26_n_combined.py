"""YOLO26-N Combined: Reparam Backbone + Channel Gate Neck (Track 1, H3).

Neck channel counts same as baseline. Backbone uses ReparamC3k2.
"""
...
from ultralytics.nn.modules.block import SPPF, C2PSA
from ultralytics.nn.modules.head import Detect

from .yolo26_n_reparam import ReparamC3k2
from .yolo26_n_gate import GatedC3k2


class YOLO26NCombined(nn.Module):
    """YOLO26-Nano with reparam backbone + gated neck."""
    ...
    def __init__(self, nc=80, reg_max=1, end2end=True):
        ...
        self.b4 = ReparamC3k2(_w(256), _w(512), _d(2), False, 0.25)
        self.b5 = Conv(_w(512), _w(512), 3, 2)
        self.b6 = ReparamC3k2(_w(512), _w(512), _d(2), True)
        ...
        self.n_cat1 = _Concat()
        self.n11 = GatedC3k2(_w(1024) + _w(512), _w(512), _d(2), True)
        self.n_up2 = nn.Upsample(scale_factor=2, mode="nearest")
        self.n_cat2 = _Concat()
        self.n12 = GatedC3k2(_w(512) + _w(512), _w(256), _d(2), True)
        self.n_down1 = Conv(_w(256), _w(256), 3, 2)
        self.n_cat3 = _Concat()
        self.n13 = GatedC3k2(_w(256) + _w(512), _w(512), _d(2), True)
        self.n_down2 = Conv(_w(512), _w(512), 3, 2)
        self.n_cat4 = _Concat()
        self.n14 = GatedC3k2(_w(512) + _w(1024), _w(1024), _d(1), True)
